...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED_DATA_Pin|LED_LATCH_Pin|LED_CLOCK_Pin|ONBOARD_LD2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, FND_DATA_Pin|FND_LATCH_Pin|FND_CLOCK_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : FND_DATA_Pin FND_LATCH_Pin FND_CLOCK_Pin */
  GPIO_InitStruct.Pin = FND_DATA_Pin|FND_LATCH_Pin|FND_CLOCK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
