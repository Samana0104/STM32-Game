...
=======
 * 버튼은 외부 풀업 회로이므로 평상시 SET(1), 누르면 RESET(0)이다.
 * LED는 GPIO가 SET(1)이면 켜지는 active-high 방식이다.
>>>>>>> 3751dfc1c22316f8a9418c86e1671eda321d99f9
 */
...
=======
  /* 버튼 또는 LED가 연결된 GPIO Peripheral과 해당 핀 번호 */
>>>>>>> 3751dfc1c22316f8a9418c86e1671eda321d99f9
  GPIO_TypeDef *port;
  uint16_t pin;
} MoleGpio;
...
<<<<<<< HEAD
=======
/* LED 3개: A0~A2 핀을 디지털 GPIO 출력으로 사용 */
static const MoleGpio mole_leds[MOLE_COUNT] =
{
  {GPIOA, GPIO_PIN_0},  /* LED 1: PA0, A0 */
  {GPIOA, GPIO_PIN_1},  /* LED 2: PA1, A1 */
  {GPIOA, GPIO_PIN_4}   /* LED 3: PA4, A2 */
};
...
static void moleAllLedOff(void)
{
  sn74hc595Write(0U);
=======
/* 게임 종료 또는 LED 변경 전에 모든 LED 출력을 LOW로 만든다. */
static void moleAllLedOff(void)
{
  uint8_t i;
  ...
  {
    HAL_GPIO_WritePin(mole_leds[i].port, mole_leds[i].pin, GPIO_PIN_RESET);
  }
>>>>>>> 3751dfc1c22316f8a9418c86e1671eda321d99f9
}
...
=======
  /* 항상 하나의 두더지만 나타나도록 기존 LED를 먼저 모두 끈다. */
  moleAllLedOff();

  if (led_number < MOLE_COUNT)
  {
    HAL_GPIO_WritePin(mole_leds[led_number].port,
                      mole_leds[led_number].pin,
                      GPIO_PIN_SET);
  }
>>>>>>> 3751dfc1c22316f8a9418c86e1671eda321d99f9
}
